...
const EditPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchArticle = async () => {
      try {
        ...
        setTwitterLink(article.twitterLink || "");
        setEditorContent(article.content || "");
        setCategory(article.category || "football");
        setSection(article.badge || "news");
      } catch (error) {
        console.error(error);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${baseUrl}/article/update/${id}`, {
        method: "PUT",
  ...
  return (
    ...
    >
      ...
      {/* Same form as your write page, but prefilled with state */}
      {/* Featured Image */}
