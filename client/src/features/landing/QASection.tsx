...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "გაქვთ თუ არა ტრანსლაციები?",
      answer:
        "დიახ, ჩვენ ვთარგმნით სიახლეებს და ისტორიებს რამდენიმე ენაზე. ძირითადად ვფოკუსირდებით ინგლისურ და რუსულ ენებზე.",
    },
    {
      question: "რატომ არ გაქვთ სხვა კატეგორიები?",
      answer:
        "ამჟამად ვფოკუსირდებით სპორტულ კონტენტზე, მაგრამ გეგმაში გვაქვს სხვა კატეგორიების დამატება მომავალში.",
    },
    {
