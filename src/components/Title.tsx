...
const Title = ({ title }: { title: string }) => {
  return (
    <div className="group mt-10 w-full border-b border-secondary flex items-center justify-between px-4 py-1.5  transition-colors duration-200 cursor-pointer">
